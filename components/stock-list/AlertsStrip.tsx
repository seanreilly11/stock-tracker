      ...
      {isEmpty ? (
        ...
        <div className="flex flex-col border-t border-[var(--rule-soft)]">
          {alerts.slice(0, 3).map((alert) => (
            ...
            >
              <span
                className={`w-[22px] h-[22px] rounded-full border inline-flex items-center justify-center font-[family-name:var(--mono)] text-[11px] ${PIP_CLASS[alert.kind]}`}
              >
              ...
              <span className="font-[family-name:var(--mono)] text-[11px] uppercase tracking-[0.06em] text-[var(--ink-2)]">
                <span className="sm:hidden font-medium text-[var(--ink)]">
                  {alert.ticker} ·{" "}
                </span>
