...
const WhySection = () => (
  <section className="py-24 bg-[var(--paper-2)] border-t border-[var(--rule-soft)] border-b border-b-[var(--rule-soft)]">
    <div className="max-w-[1200px] mx-auto px-10">
      ...
      >
        Most tools treat trading like a{" "}
        <em className="italic text-[var(--accent)]">picking</em> problem.
        <br />
        But picking isn&apos;t usually where it goes wrong.
      </h2>

      <div
        className="grid gap-[60px] mt-3"
      ...
      >
        <div>
          <p className="font-[family-name:var(--serif)] text-[18.5px] leading-[1.55] text-[var(--ink-2)] mb-4">
            Find the right stock, the right entry, the right indicator -
            that&apos;s what every other tool tries to help with.{" "}
            <strong className="text-[var(--ink)] font-medium">
              Executing your own plan is
            </strong>{" "}
            where it actually breaks.
          </p>
          <p className="font-[family-name:var(--serif)] text-[18.5px] leading-[1.55] text-[var(--ink-2)] mb-4">
            You had a target and didn&apos;t act on it, because in the moment
            you second-guessed it. You meant to sell into strength and held too
            long. You bought the dip - the wrong dip - because the plan was in
            your head, not in front of you.
          </p>
          <p className="font-[family-name:var(--serif)] text-[18.5px] leading-[1.55] text-[var(--ink-2)]">
            None of that is a research failure. It&apos;s a <em>preparation</em>{" "}
            failure. The plan existed; it just wasn&apos;t ready when you needed
            it.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-6">
          {WHY_POINTS.map((pt) => (
            <div
              key={pt.num}
              className="bg-[var(--paper)] border border-[var(--rule)] p-[22px_24px_24px] relative"
            >
        ...
        <div className="grid gap-7" style={{ gridTemplateColumns: "1fr 1fr" }}>
          ...
          >
            <div className="flex justify-between items-baseline mb-[18px]">
              <span className="font-[family-name:var(--mono)] text-[11px] uppercase tracking-[0.10em] text-[var(--ink)]">
                Unprepared
              </span>
          ...
          <div className="p-[22px] bg-[var(--paper)] border border-[var(--rule)] rounded-md flex flex-col min-h-[320px]">
            ...
            <div className="flex-1">
              ...
              <p className="font-[family-name:var(--serif)] italic text-[15px] leading-[1.55] text-[var(--ink-2)] border-l-2 border-[var(--ink)] pl-3 mb-[18px]">
                ...
                guide holds. Stop $96 if guide cuts.&quot;
              </p>
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <div
                    key={t.kind}
                    className="grid items-center gap-2.5 px-2.5 py-2 bg-[var(--paper-2)] rounded-[3px] font-[family-name:var(--mono)] text-[12px]"
                    style={{ gridTemplateColumns: "48px 64px 1fr" }}
                  >
                    <span
      ...
      <p className="font-[family-name:var(--serif)] text-[17px] leading-[1.55] text-[var(--ink-2)] mt-12 max-w-[780px]">
        Preparation won&apos;t promise you profits - nobody honest can. But
        being <em>unprepared</em> will quietly cost you them. {APP_TITLE} is the
        difference between watching the move happen and being ready for it.
      </p>
    </div>
  </section>
);
