...
const HeroSection = ({ onGetStarted }: HeroSectionProps) => (
  ...
  >
    <div className="max-w-[1200px] mx-auto px-10">
      <div className="inline-flex items-center gap-2 font-[family-name:var(--mono)] text-[11px] uppercase tracking-[0.10em] text-[var(--ink-3)] px-3 py-1.5 border border-[var(--rule)] rounded-full bg-[var(--paper)] mb-8">
        <span
      ...
      >
        {APP_TITLE} is a research notebook for traders who&apos;d rather be
        prepared than fast. Write your thesis. Set your buy, sell, and stop
        targets. When the price moves or the news breaks, you already know what
        to do - because you decided when you were calm.
      </p>
...
function HeroVisual() {
  ...
  return (
    <div
      className="mt-16 relative rounded-xl bg-[var(--paper)]"
      aria-hidden="true"
    >
      <div
        className="border border-[var(--rule)] rounded-lg bg-[var(--paper)] overflow-hidden"
        style={{
          boxShadow:
            "0 1px 0 var(--rule-soft), 0 24px 60px -30px oklch(20% 0.02 60 / 0.25), 0 60px 120px -40px oklch(20% 0.02 60 / 0.15)",
        }}
      >
        {/* Chrome bar */}
        ...
        >
          ...
          <div className="border-r border-[var(--rule)] py-3.5 bg-[var(--paper-2)]">
            ...
            {watchlist.map((r) => (
              ...
              >
                ...
                <span className="text-[var(--ink)] tracking-[0.04em]">
                  {r.t}
                </span>
                <span className="font-[family-name:var(--sans)] text-[11px] text-[var(--ink-3)] overflow-hidden text-ellipsis whitespace-nowrap">
                  {r.n}
                </span>
                <span
                  className={`text-[10.5px] ${r.up ? "text-[var(--green)]" : "text-[var(--accent)]"}`}
                >
                  {r.c}
                </span>
              </div>
          ...
          <div className="p-[22px_26px]">
            ...
            <div className="flex items-baseline gap-3 flex-wrap mb-1.5">
              ...
              <span className="font-[family-name:var(--mono)] text-[12px] text-[var(--ink-3)] tracking-[0.04em]">
                TSLA
              </span>
            </div>
            ...
            <div className="flex items-center gap-2.5 px-3 py-2.5 mb-5 text-[12.5px] text-[var(--ink-2)] rounded bg-[var(--accent-soft)] border border-[var(--accent-line)]">
              <span className="font-[family-name:var(--mono)] text-[10px] uppercase tracking-[0.10em] text-[var(--accent)] font-medium">
                Alert
              </span>
              <span>
                <strong>BUY target $190</strong> within reach - your March
                thesis is ready for you.
              </span>
            </div>
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    background:
                      pip.kind === "now" ? "var(--ink)" : "var(--paper)",
                    border: `2px solid ${
                      pip.kind === "now"
                        ? "var(--ink)"
                        : pip.kind === "buy"
            ...
            <div className="pt-4 border-t border-[var(--rule)]">
              ...
              <p className="font-[family-name:var(--serif)] text-[14px] leading-[1.5] text-[var(--ink-2)] m-0">
                AV optionality is the only thing here. If FSD ships v13 with
                credible miles-between-disengagement data, the auto narrative
                reopens.
              </p>
            </div>
          </div>
