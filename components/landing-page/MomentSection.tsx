...
const MomentSection = () => (
  <section id="moment" className="py-24 border-t border-[var(--rule-soft)]">
      ...
      >
        ...
        <div>
          ...
          <p className="font-[family-name:var(--serif)] text-[18.5px] leading-[1.55] text-[var(--ink-2)] mb-4">
            You had time. You read the earnings call, traced the supply chain,
            talked yourself through the bear case. You wrote it down - what you
            believed, the price you&apos;d act on, the risk that would change
            your mind.
          </p>
          <p className="font-[family-name:var(--serif)] italic text-[var(--ink-3)] border-l-2 border-[var(--rule)] pl-4 my-6 text-[18.5px] leading-[1.55]">
            Then life moved on. You forgot the details. You opened the app twice
            in October.
          </p>
          ...
          <p className="font-[family-name:var(--serif)] text-[18.5px] leading-[1.55] text-[var(--ink-2)] mb-4">
            And here&apos;s where trades are won and lost - not in the research,
            in the <em>response.</em>
          </p>
          <p className="font-[family-name:var(--serif)] text-[18.5px] leading-[1.55] text-[var(--ink-2)] mb-4">
            The unprepared version of you scrambles. The move happens{" "}
            <em>to</em> you.
          </p>
          <p className="font-[family-name:var(--serif)] text-[18.5px] leading-[1.55] text-[var(--ink-2)] mb-4">
            The prepared version opens one email. Your thesis is there. Your
            targets are there. You act - on a decision you already made, calmly,
            months ago.
          </p>
          <div className="mt-7 px-[22px] py-5 bg-[var(--paper-2)] border-l-[3px] border-[var(--ink)] font-[family-name:var(--serif)] text-[17px] text-[var(--ink)]">
            <strong>That&apos;s the whole product.</strong> {APP_TITLE}{" "}
            doesn&apos;t predict the move. It makes sure that when the move
            comes, you meet it with a plan instead of a panic.
          </div>
        </div>

        {/* Visual */}
        <div className="relative bg-[var(--paper-2)] border border-[var(--rule)] rounded-lg p-7 top-[100px] sticky">
          <div className="flex flex-col gap-0">
            ...
            >
              <div className="flex items-center gap-2.5 mb-2.5">
                ...
                <span className="font-[family-name:var(--mono)] text-[10.5px] text-[var(--ink-3)] ml-auto">
                  Jan 15 · 10:42
                </span>
              </div>
              <p className="font-[family-name:var(--serif)] text-[15px] leading-[1.5] text-[var(--ink-2)] italic m-0">
                &quot;Buy if pullback to $108 - but only if datacenter capex
                guide holds in Q4 print. Stop $96 if guide cuts.&quot;
              </p>
              <div className="flex gap-1.5 mt-2.5">
                {["thesis", "target-buy"].map((t) => (
                  <span
                    key={t}
                    className="font-[family-name:var(--mono)] text-[9.5px] text-[var(--ink-3)] px-1.5 py-0.5 bg-[var(--paper-2)] rounded"
                  >
                    {t}
                  </span>
                ))}
            ...
            <div className="relative py-[18px] pl-7 ml-[22px] border-l border-dashed border-[var(--rule)]">
              <span className="absolute left-[-5px] top-2 w-[9px] h-[9px] rounded-full bg-[var(--ink-4)]" />
              <span className="absolute left-[-5px] bottom-2 w-[9px] h-[9px] rounded-full bg-[var(--accent)]" />
