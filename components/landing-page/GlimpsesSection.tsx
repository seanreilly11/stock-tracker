  ...
  return (
    <div className="bg-[var(--paper)] border border-[var(--rule)] rounded-md p-[22px_24px] font-[family-name:var(--sans)]">
      ...
      <div className="flex items-baseline gap-2.5 flex-wrap mb-1.5">
        <h3 className="font-[family-name:var(--serif)] font-medium text-[26px] leading-[1.1] tracking-[-0.02em] m-0 text-[var(--ink)]">
          NVIDIA Corp.
        </h3>
        <span className="font-[family-name:var(--mono)] text-[11px] text-[var(--ink-3)] tracking-[0.04em]">
          NVDA
        </span>
      </div>
      ...
      <p className="font-[family-name:var(--serif)] text-[14px] leading-[1.5] text-[var(--ink-2)] m-0">
        Datacenter capex isn&apos;t peaking yet. Hyperscalers guided +30% capex
        for FY26.
      </p>
      <div className="font-[family-name:var(--mono)] text-[10px] uppercase tracking-[0.10em] text-[var(--ink-4)] mt-[18px] mb-2 pb-1.5 border-b border-[var(--rule-soft)]">
        Notes · 3 of 12
      ...
      <div className="flex flex-col gap-2 mt-1">
        {[
          { kind: "plan", when: "Mar 14", body: "Buy on pullback to $120…" },
          {
            kind: "risk",
            when: "Apr 02",
            body: "Export ruling - watch April…",
          },
          { kind: "alert", when: "Apr 22", body: "BUY $120 hit. Email sent." },
        ].map((n) => (
          <div
            key={n.when}
            className="flex items-baseline gap-2 font-[family-name:var(--serif)] text-[13px] text-[var(--ink-2)]"
          >
            <span
  ...
  const rows = [
    {
      k: "buy",
      p: "$165",
      l: "Pullback / accumulate",
      n: "21d MA + multiple support",
    },
      ...
      <div className="flex flex-col gap-1.5 mt-1">
        {rows.map((r) => (
          ...
          >
            ...
            <span className="font-[family-name:var(--mono)] text-[14px] text-[var(--ink)]">
              {r.p}
            </span>
            <div className="flex flex-col gap-0.5">
              <span className="font-[family-name:var(--sans)] text-[13px] text-[var(--ink)]">
                {r.l}
              </span>
              <span className="font-[family-name:var(--serif)] italic text-[12px] text-[var(--ink-3)]">
                {r.n}
              </span>
            </div>
...
function GlimpseEmail() {
  return (
    <div className="bg-[var(--paper)] border border-[var(--rule)] rounded-md overflow-hidden">
      <div
        className="grid"
        style={{ gridTemplateColumns: "200px 1fr", minHeight: 360 }}
      >
        <div className="bg-[var(--paper-2)] border-r border-[var(--rule)]">
          {[
            {
              from: APP_TITLE,
              subj: "BUY $120 hit · NVDA - your thesis",
              when: "9:14",
              active: true,
            },
            {
              from: "Patagonia",
              subj: "Spring arrivals",
              when: "8:42",
              active: false,
            },
            {
            ...
            >
              ...
              <span className="font-medium text-[var(--ink)] font-[family-name:var(--sans)]">
                {row.from}
              </span>
              <span className="font-[family-name:var(--mono)] text-[var(--ink-4)]">
                {row.when}
              </span>
              <span className="col-span-2 font-[family-name:var(--serif)] text-[12px] text-[var(--ink-2)] whitespace-nowrap overflow-hidden text-ellipsis">
                {row.subj}
              </span>
            </div>
          ))}
        ...
        <div className="p-[18px_22px]">
          <div className="flex justify-between items-baseline pb-3 mb-4 border-b border-[var(--rule-soft)]">
            <span className="font-[family-name:var(--serif)] text-[18px] font-medium text-[var(--ink)] tracking-[-0.01em]">
              BUY $120 hit · NVDA - your thesis
            </span>
            <span className="font-[family-name:var(--mono)] text-[10.5px] text-[var(--ink-3)]">
              Apr 22 · 9:14am
            </span>
          </div>
          <div className="bg-[var(--paper-2)] border-l-[3px] border-[var(--accent)] px-3.5 py-3 mb-3.5">
            <div className="font-[family-name:var(--mono)] text-[9.5px] uppercase tracking-[0.10em] text-[var(--ink-4)] mb-1.5">
              Your thesis · written Mar 14 · 98 days ago
            </div>
            <p className="font-[family-name:var(--serif)] italic text-[13px] leading-[1.5] text-[var(--ink-2)] m-0">
              Datacenter capex isn&apos;t peaking yet. Hyperscalers guided +30%
              capex for FY26.
            </p>
          </div>
          <div className="font-[family-name:var(--mono)] text-[9.5px] uppercase tracking-[0.10em] text-[var(--ink-4)] mb-1.5">
          ...
          {[
            {
              kind: "risk",
              when: "Apr 02",
              body: "Export ruling - watch April. If chips banned to China, reset target $108.",
            },
            {
              kind: "idea",
              when: "Mar 28",
              body: "Q1 print: capex +34% YoY beat. Thesis still intact.",
            },
            {
              kind: "plan",
              when: "Mar 14",
              body: "Buy on pullback to $120 if capex guide holds.",
            },
          ].map((n) => (
            <div
              key={n.when}
              className="flex gap-2 items-baseline font-[family-name:var(--serif)] text-[12.5px] py-1.5 border-b border-[var(--rule-soft)] text-[var(--ink-2)] last:border-0"
            >
              <span
              ...
              <span className="font-[family-name:var(--mono)] text-[10px] text-[var(--ink-4)] flex-shrink-0">
                {n.when}
              </span>
              {n.body}
            </div>
      ...
      >
        {slots.map((s) => (
          <div
            ...
            style={
              s.top
                ? { background: "var(--paper)", borderColor: "var(--ink-3)" }
                : {}
            }
          >
            <div
            ...
            <div className="font-[family-name:var(--mono)] text-[14px] text-[var(--ink)] tracking-[0.04em] font-medium">
              {s.tick}
            </div>
            <div className="text-[11.5px] text-[var(--ink-3)] mt-0.5">
              {s.name}
            </div>
            <div className="font-[family-name:var(--mono)] text-[10px] text-[var(--ink-3)] mt-2 mb-1.5">
              {s.meta}
            </div>
            <div className="h-[3px] bg-[var(--rule-soft)] rounded overflow-hidden mb-1.5">
              <div
                ...
                style={{
                  width: s.fill,
                  background: s.top ? "var(--accent)" : "var(--ink-2)",
                }}
              />
            </div>
            <div className="font-[family-name:var(--mono)] text-[9.5px] text-[var(--ink-4)] tracking-[0.02em]">
              {s.foot}
            </div>
          </div>
        ))}
      ...
      <div className="flex flex-col gap-20">
          ...
          caption={
            <>
              <strong className="text-[var(--ink)] font-medium">
                A research notebook, not a watchlist.
              </strong>{" "}
              Every stock has a thesis, a list of buy/sell/stop targets with the
              reasoning for each, and a timeline of your notes.
            </>
          }
        ...
        <GlimpseCard
          ...
          caption={
            <>
              <strong className="text-[var(--ink)] font-medium">
                A plan for up, down, and sideways.
              </strong>{" "}
              Buy at $165 if it pulls back. Trim at $200. Stop at $108 if the
              thesis breaks. You decide your response to every direction - once,
              in advance.
            </>
          }
        ...
        <GlimpseCard
          ...
          caption={
            <>
              <strong className="text-[var(--ink)] font-medium">
                Your thesis, returned to you on time.
              </strong>{" "}
              Every alert email contains every note you&apos;ve written on the
              stock, newest first. Everything you need to respond correctly, the
              moment it matters.
            </>
          }
          visual={<GlimpseEmail />}
        ...
        <GlimpseCard
          ...
          caption={
            <>
              ...
              What you&apos;re saving for. What your next paycheck is going
              toward. A deliberate shortlist, not an endless list.
            </>
          }
          visual={<GlimpseShelf />}
          flip
