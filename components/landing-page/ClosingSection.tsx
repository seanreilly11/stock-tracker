  ...
  >
    <div className="max-w-[820px] mx-auto px-10 text-center">
      ...
      <h2
        ...
        style={{ fontSize: "clamp(46px, 6vw, 80px)", lineHeight: 1.06, letterSpacing: "-0.02em" }}
      >
        The move is coming
        <br />
        either way.
      ...
      >
        The only question is whether it happens <em>to</em> you, or whether you meet it with a plan.
      </p>
